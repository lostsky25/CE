...
void Engine::setPixelSize(int width, int height) {
...
void Engine::addModel(TModel* model) {
...
bool Engine::detectCollision(TModel first, TModel second) {
    float a_l = 0;
    float b_l = 0;
...
BOOL Engine::SetConsoleSize(int cols, int rows) {
    int w, h, bw, bh;
    RECT rect = { 0, 0, 0, 0 };
    COORD coord = { 0, 0 };
